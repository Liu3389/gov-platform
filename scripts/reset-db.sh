...
SELECT 'gov_activiti', COUNT(*) FROM gov_activiti.t_workflow_process UNION
...
SELECT 'gov_message', COUNT(*) FROM gov_message.t_message_template UNION
SELECT 'gov_monitor', COUNT(*) FROM gov_monitor.t_operate_log UNION
SELECT 'gov_datashare', COUNT(*) FROM gov_datashare.t_share_api;
" 2>/dev/null
