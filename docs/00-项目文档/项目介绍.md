...
| 注册 & 配置中心 | Nacos                     | 2.3.2           | 服务注册发现 + 配置中心              |
...
| 组员 D | `gov-complaint-service` (8086)`gov-datashare-service` (8088)`gov-message-service` (8089)`gov-web` | 投诉建议、督办催办、数据共享、消息通知、Vue 前端、前后端联调、Nginx 本地代理 |
