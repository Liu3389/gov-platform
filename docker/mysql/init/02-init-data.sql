...
-- 2. 部门信息（gov_user 库）
-- =====================================================
INSERT INTO t_dept_info (id, dept_name, dept_code, parent_id, dept_type, leader_id, phone, address, sort, status, create_time) VALUES
(10001, '政务服务中心', 'GOV001', 0, 1, NULL, '0512-12345678', '苏州市政务服务中心', 1, 1, NOW()),
(10002, '公安局', 'POL001', 10001, 1, NULL, '0512-12345679', '苏州市公安局', 2, 1, NOW()),
(10003, '民政局', 'CIV001', 10001, 1, NULL, '0512-12345680', '苏州市民政局', 3, 1, NOW()),
(10004, '人社局', 'HR001', 10001, 1, NULL, '0512-12345681', '苏州市人社局', 4, 1, NOW()),
(10005, '卫健委', 'HEA001', 10001, 1, NULL, '0512-12345682', '苏州市卫健委', 5, 1, NOW());

-- =====================================================
-- 3. 角色信息（gov_user 库）
-- =====================================================
INSERT INTO t_role_info (id, role_name, role_code, status, create_time) VALUES
(1, '超级管理员', 'admin', 1, NOW()),
(2, '窗口工作人员', 'window_staff', 1, NOW()),
(3, '部门审批人', 'dept_approver', 1, NOW()),
(4, '普通用户', 'user', 1, NOW());
